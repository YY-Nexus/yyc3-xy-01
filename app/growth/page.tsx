...
const mockAssessmentResult = {
  ...
  dimensionScores: {
    "学业基础": { score: 85, level: "良好", percentile: 75, description: "学业基础扎实，各科目表现良好" },
    "学习习惯": { score: 82, level: "良好", percentile: 70, description: "学习习惯基本养成，需要进一步巩固" },
    "逻辑思维": { score: 90, level: "优秀", percentile: 85, description: "逻辑思维能力突出，善于发现规律" },
    "自我管理": { score: 78, level: "良好", percentile: 65, description: "自我管理能力良好，需要提升时间管理" },
    "社交能力": { score: 92, level: "优秀", percentile: 88, description: "社交能力强，与同伴相处融洽" },
  },
  overallLevel: "良好",
  aiAnalysis: "小云整体发展良好，在逻辑思维和社交能力方面表现突出。建议重点关注时间管理和自主学习能力的培养，通过游戏化方式激发学习兴趣。继续保持良好的学习习惯，同时加强独立完成作业的能力。",
  recommendations: [
