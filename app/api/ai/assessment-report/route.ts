...
// 分析各维度得分
function analyzeDimensions(scores: Record<string, number>) {
...
// 计算总体发展水平
function calculateOverallLevel(dimensionAnalysis: Record<string, any>) {
  const scores = Object.values(dimensionAnalysis).map((d: any) => d.score)
