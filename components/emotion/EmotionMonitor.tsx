/**
 * @file EmotionMonitor.tsx
 * @description YYC³ AI小语智能成长守护系统情感监测组件，实时显示情感状态、趋势和洞察
...
import { useEmotionMonitor, EmotionInsight } from '@/hooks/useEmotionMonitor'
import { EmotionType } from '@/lib/ai/emotion-monitor'
import { EmotionAlert, EmotionEvent } from '@/lib/ai/emotion-monitor'
...
export default function EmotionMonitor({
  ...
  const [detailedReport, setDetailedReport] = useState<EmotionReport | null>(null)
...
function DetailedEmotionReport({ report }: { report: EmotionReport }) {
  return (
    <div>
